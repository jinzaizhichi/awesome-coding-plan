...
|--------------------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------|---------|-----------|---------|--------|-----------|--------|--------|-------------|---------|
| [Claude Pro](https://claude.ai/upgrade) (Claude Code claude-opus-4.8)       |  $20.00   | 2026-5-6 后 5h 额度翻倍, 5-14 至 7-13 周额度增加 50%（统计数据为额度增加后的统计数据）  | /    | 359/3966万     |  $31.84   | 1.59    | 3590/3.97亿  |  $318.4  |  15.9  | 14360/15.88亿  |  $1273.6       | 63.6   |
| [ChatGPT Plus](https://chatgpt.com/pricing) (Codex gpt-5.4)           |  $20.00 | 45-225 Local Messages* / 5h | /    | 490/2000万    |  $11.85   | 0.59    | 3062/1.2亿   |  $74   | 3.7   | 12250/4.8亿  |  $296       | 14.8   |
...
| grok-4.5🏞️ | 2026-07-09 |  || 500K | 99.96% | |
...
找了一个 gemini-3.5-flash BUG 解决失败的烂摊子场景让其他模型接手修复，以下是各个模型的完成情况，可作为日常编码模型选择的参考。
