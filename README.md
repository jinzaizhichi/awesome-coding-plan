...
| ⚠️[Kiro Pro](https://kiro.dev/pricing) |   $20.00 (新注册首月免费，退出付款页丢失免费资格)<br/>Kiro IDE 貌似有 BUG，Command 频繁卡 Waiting on your input（多次继续无效）, kiro-cli 暂时没问题  |   1,000 credits<br/>Pay-per-use overage ($0.04/credit)<br/>Get 500 bonus credits usable within 30 days when you first sign up    |    Usage-based    |     $40.00      |   2  | 
